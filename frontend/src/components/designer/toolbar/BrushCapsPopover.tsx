...
export const BrushCapsPopover: React.FC<BrushCapsPopoverProps> = ({
  ...
  return (
    <div
      ...
      className="absolute top-full left-0 mt-2 w-64 bg-white rounded-2xl shadow-2xl border border-gray-200 p-3.5 z-50 animate-in fade-in zoom-in-95 duration-100 select-none space-y-3.5"
    >
      {/* End Caps */}
