      ...
      <div className="flex items-center gap-2" ref={exportMenuRef}>
        ...
        <div className="relative">
          <button
            ...
            title="Export Artwork (JPEG, PNG, WebP, PDF, TIFF, PSD, AI Upscaling)"
          >
          ...
          {activeMenu === 'export' && (
            <div className="absolute top-full right-0 mt-1.5 w-72 bg-white rounded-xl shadow-2xl border border-gray-200 py-2 z-50 animate-in fade-in slide-in-from-top-1 duration-100">
              {/* Primary AI Upscaling & Multi-Format Modal Action */}
              {onOpenExportModal && (
                <div className="px-2 pb-1.5 mb-1 border-b border-gray-100">
                  <button
                    ...
                    className="w-full px-3 py-2 text-left rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 text-blue-950 flex items-center justify-between border border-blue-200 transition group"
                  >
                    <span className="flex items-center gap-2 font-bold text-xs">
                      <Sparkles className="w-4 h-4 text-blue-600" />
                      <span>Full Export & AI Upscale...</span>
                    </span>
                    <span className="text-[10px] bg-blue-600 text-white px-1.5 py-0.5 rounded font-semibold shadow-xs">
                      Presets
                    </span>
                  </button>
                </div>
